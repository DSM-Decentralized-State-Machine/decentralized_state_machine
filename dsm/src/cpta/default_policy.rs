...
pub fn generate_specialized_policy(
    ...
    match policy_type {
        "TimeLocked" => {
            ...
            policy
                .conditions
                .retain(|c| !matches!(c, PolicyCondition::TimeLock { .. }));
            policy.add_condition(PolicyCondition::TimeLock { unlock_time });

            // Update metadata
            policy
                .add_metadata("policy_type", "time_locked")
        ...
        "GeographicRestriction" => {
            ...
            policy.add_condition(PolicyCondition::GeographicRestriction { allowed_regions });
